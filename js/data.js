...
const UPACHAR_DATA = {
  ...
  translations: {
    en: {
      ...
      btnBookNow: "Book Home Care",
      btnAppointment: "Book Online Appointment",
      btnSampleCollection: "Book Home Sample Collection",
      ...
      statNurses: "250+",
      statNursesLabel: "Certified Nurses & Doctors",
      statCities: "24/7",
      statCitiesLabel: "Emergency Support",
      statRating: "4.9 ★",
      ...
      tabAll: "All Services",
      tabNurse: "Nurse @ Home",
      tabDoctor: "Doctor @ Home",
      tabEquipment: "Equipment @ Home",
    ...
    hi: {
      ...
      btnBookNow: "स्वास्थ्य सेवा बुक करें",
      btnAppointment: "ऑनलाइन अपॉइंटमेंट बुक करें",
      btnSampleCollection: "सैंपल कलेक्शन बुक करें",
      ...
      tabAll: "सभी सेवाएं",
      tabNurse: "नर्स @ होम",
      tabDoctor: "डॉक्टर @ होम",
      tabEquipment: "उपकरण @ होम",
      tabDiagnostics: "जांच @ होम",
      tabPhysio: "फिजियोथेरेपी @ होम",
  ...
  costDatabase: [
    ...
    { id: "c3", nameEn: "PICC / Central Line Dressing", nameHi: "पीआईसीसी / सेंट्रल लाइन ड्रेसिंग", category: "Nurse @ Home", cost: "₹799 - ₹1,199", inclusionsEn: "Heparin flush, sterile dressing change, infection control", inclusionsHi: "हेपरिन फ्लश, स्टेराइल ड्रेसिंग बदलाव" },
    { id: "c4", nameEn: "IV Fluids / IV Injection Administration", nameHi: "आईवी ड्रिप व इंजेक्शन", category: "Nurse @ Home", cost: "₹399 - ₹699", inclusionsEn: "IV cannula insertion, drip monitoring, drug administration", inclusionsHi: "आईवी कैनुला लगाना, ड्रिप मॉनिटरिंग" },
    { id: "c5", nameEn: "12-Hour Nursing Shift", nameHi: "12 घंटे की नर्सिंग शिफ्ट", category: "Nurse @ Home", cost: "₹1,200 - ₹1,800 / shift", inclusionsEn: "Vitals monitoring, meds administration, personal hygiene", inclusionsHi: "वाइटल्स मॉनिटरिंग, दवा देना, व्यक्तिगत देखभाल" },
    { id: "c6", nameEn: "24-Hour ICU Trained Nursing Care", nameHi: "24 घंटे की आईसीयू नर्स", category: "Nurse @ Home", cost: "₹2,200 - ₹3,000 / day", inclusionsEn: "Continuous ICU bed monitoring, ventilator support, complete patient care", inclusionsHi: "आईसीयू बेड मॉनिटरिंग, वेंटिलेटर सहायता" },
    { id: "c7", nameEn: "Doctor Home Consultation", nameHi: "डॉक्टर विजिट / परामर्श", category: "Doctor @ Home", cost: "₹999 - ₹1,499", inclusionsEn: "Bedside evaluation, physical exam, prescription & diagnosis", inclusionsHi: "घर पर शारीरिक जांच, निदान व दवा पर्चा" },
    { id: "c8", nameEn: "Pleural Fluid Tapping", nameHi: "प्लुरल फ्लूड टैपिंग (फेफड़ों से पानी)", category: "Doctor @ Home", cost: "₹2,499 - ₹3,999", inclusionsEn: "Fluid aspiration by experienced physician with local anesthesia", inclusionsHi: "अनुभवी डॉक्टर द्वारा फ्लूइड निकालना" },
    { id: "c9", nameEn: "Suture / Stitch Removal", nameHi: "टांके काटना व निकालना", category: "Doctor / Nurse", cost: "₹499 - ₹799", inclusionsEn: "Sterile stitch removal, wound cleaning & fresh dressing", inclusionsHi: "टांके निकालना, घाव की सफाई व ड्रेसिंग" },
    { id: "c10", nameEn: "Chemotherapy Administration @ Home", nameHi: "घर पर कीमोथेरेपी", category: "Doctor / Nurse", cost: "₹3,500 - ₹5,500", inclusionsEn: "Onco-nurse supervision, IV chemo drip & anti-emetic care", inclusionsHi: "ऑन्को-नर्स देखरेख में कीमोथेरेपी ड्रिप" },
  ...
  services: [
    ...
    },
    {
      ...
      procedures: [
        ...
        { en: "Suture / Stitch removal (Sciture removing)", hi: "टांके काटना व निकालना (Suture removal)" },
        { en: "Chemotherapy administration @ home", hi: "घर पर कीमोथेरेपी (Chemo @ home)" }
      ]
    },
    {
      id: "equipment",
      ...
      procedures: [
        ...
        { en: "Medical Consumables & Medicines Delivery", hi: "मेडिकल कंज्यूमेबल्स व दवाइयां आपूर्ति" }
      ]
    },
    {
      id: "diagnostics",
      ...
      procedures: [
        ...
        { en: "Home Digital X-Ray & ECG Test", hi: "घर पर पोर्टेबल डिजिटल एक्स-रे व ईसीजी" }
      ]
    },
    {
      id: "physio",
      ...
      procedures: [
        ...
        { en: "Vascular Rehab", hi: "वैस्कुलर रिहैब" },
        { en: "Paediatric Physiotherapy", hi: "बाल चिकित्सा (पीडियाट्रिक) फिजियोथेरेपी" }
      ]
    }
  ],
